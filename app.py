...
with right:
    sql_box(sql_1)
insight_box([
    "2020~2021년 외래 방한객 수가 급감했으나, 카지노 입장객은 상대적으로 빠르게 회복되었습니다.",
    "이는 방한 관광 회복 초기에는 카지노를 주요 목적으로 방문하는 고객 비중이 증가했음을 시사합니다."
])
section_close()
...
with right:
    sql_box(sql_2)
insight_box([
    "강원랜드가 매출 규모 1위로 시장을 주도하고 있으며, 파라다이스시티와 드림타워는 입장객당 매출이 높아 고수익 전략이 돋보입니다.",
    "사업장별로 규모 중심 전략과 고객 가치 중심 전략의 차별화가 뚜렷합니다."
])
section_close()
...
with right:
    sql_box(sql_3)
    insight_box([
        "중국, 홍콩, 일본 등 아시아권 고객이 전체의 대부분을 차지하고 있습니다.",
        "특정 국가에 대한 높은 의존도는 환율, 입국 정책, 외교 이슈 등에 취약할 수 있어 시장 다변화 전략이 필요합니다."
    ])
section_close()
